...
if ( ! function_exists( 'ayaportfolio_setup' ) ) :
	...
	function ayaportfolio_setup() {
		...
		$starter_content = array(
			...
			'theme_mods' => array(
				'ayaportfolio_slider_display' => 1,
				'ayaportfolio_slide1_image' => esc_url( get_template_directory_uri() . '/images/slider/1.jpg' ),
				'ayaportfolio_slide1_content' => _x( '<h2>Slide 1 Title</h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#" title="Read more">Read more</a>', 'Theme starter content', 'ayaportfolio' ),
				'ayaportfolio_slide2_image' => esc_url( get_template_directory_uri() . '/images/slider/2.jpg' ),
				'ayaportfolio_slide2_content' => _x( '<h2>Slide 2 Title</h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#" title="Read more">Read more</a>', 'Theme starter content', 'ayaportfolio' ),
				'ayaportfolio_slide3_image' => esc_url( get_template_directory_uri() . '/images/slider/3.jpg' ),
				'ayaportfolio_slide3_content' => _x( '<h2>Slide 3 Title</h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#" title="Read more">Read more</a>', 'Theme starter content', 'ayaportfolio' ),
				'ayaportfolio_slide4_image' => esc_url( get_template_directory_uri() . '/images/slider/4.jpg' ),
				'ayaportfolio_slide4_content' => _x( '<h2>Slide 4 Title</h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#" title="Read more">Read more</a>', 'Theme starter content', 'ayaportfolio' ),
				'ayaportfolio_slide5_image' => esc_url( get_template_directory_uri() . '/images/slider/5.jpg' ),
				'ayaportfolio_slide5_content' => _x( '<h2>Slide 5 Title</h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#" title="Read more">Read more</a>', 'Theme starter content', 'ayaportfolio' ),
			),
			...
			'nav_menus' => array(
				...
				'primary' => array(
					'name' => __( 'Primary Menu', 'ayaportfolio' ),
					'items' => array(
						'link_home',
						'page_blog',
						'page_contact',
				...
				'footer' => array(
					'name' => __( 'Footer Menu', 'ayaportfolio' ),
					'items' => array(
						'link_home',
						'page_about',
						'page_blog',
		...
		$starter_content = apply_filters( 'ayaportfolio_starter_content', $starter_content );
...
function ayaportfolio_register_block_styles() {

	register_block_style(
		'core/button',
		array(
			'name'  => 'btn',
			'label' => __( 'Hover Effect', 'ayaportfolio' ),
		)
	);
	...
	register_block_style(
		...
		array(
			'name'  => 'tgroup',
			'label' => __( 'Margin Bottom Space', 'ayaportfolio' ),
		)
	);
	...
	register_block_style(
		...
		array(
			'name'  => 'tsociallinks',
			'label' => __( 'Square', 'ayaportfolio' ),
		)
	);
}
add_action( 'init', 'ayaportfolio_register_block_styles' );
